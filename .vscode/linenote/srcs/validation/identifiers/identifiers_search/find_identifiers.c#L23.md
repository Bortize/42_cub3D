Eliminando los espacios y tabulaciones de una linea obtenida, podemos averiguar de que identificador se trata por el numero de valores que componen ese identificador.
