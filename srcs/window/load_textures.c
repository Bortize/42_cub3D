...
/*   Updated: 2021/02/09 17:27:26 by bgomez-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_textures(t_cub3d *cub)
{
	...
	cub->no_text.addr = mlx_get_data_addr(cub->no_text.img_text, cub->no_text.bpp,
	cub->no_text.size_line, cub->no_text.endian);
	cub->so_text.addr = mlx_get_data_addr(cub->so_text.img_text, cub->so_text.bpp,
	cub->so_text.size_line, cub->so_text.endian);
	cub->we_text.addr = mlx_get_data_addr(cub->we_text.img_text, cub->we_text.bpp,
	cub->we_text.size_line, cub->we_text.endian);
	cub->ea_text.addr = mlx_get_data_addr(cub->ea_text.img_text, cub->ea_text.bpp,
